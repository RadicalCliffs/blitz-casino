...
{
    // Configure these via environment variables for your own VK integration
    const SECRET = ''; // Set VK_CALLBACK_SECRET in .env
    const GROUP_ID = 0; // Set VK_GROUP_ID in .env  
    const CONFIRMATION_TOKEN = ''; // Set VK_CONFIRMATION_TOKEN in .env
    ...
    public function messageNew(int $group_id, ?string $secret, array $object)
    {
        ...
        $arr = [
            [
                "key" => "hello",
                "func" => function () {
                    $this->sendMessage($this->chatId, "Hello, Friend!");
                },
            ],
            [
                "key" => "how are you",
                "func" => function () {
                    $this->sendMessage($this->chatId, "Good, and you?");
                    },
            ],
            ...
            [
                "key" => "hi",
                "func" => function () {
                    $this->sendMessage($this->chatId, "Hey there!");
                },
            ]
        ...
        if (!$is_found)
            //$this->sendMessage($this->chatId, "I don't understand you!");

        //$this->sendMessage($this->chatId,"Thank you! Your message: $this->text ");
        echo 'ok';
    }
