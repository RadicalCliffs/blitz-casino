...
class UpdateTournier implements ShouldQueue
{
    ...
    {   
        ...
        if($tournier_type == 1){
            $end = date("d.m.Y in H:i", $tournier->end);
            ...
            $response = $vk->wall()->post($access_token, array(
                'owner_id' => -206394471,
                'message' => "&#128165; Tournament started for game mode ".$tournier->game.". The more total winnings you have by the end of the tournament, the higher your prize will be. \n\n &#9851; Prize pool - ".$tournier->prize."r \n &#9851; Prize places - ".$tournier->places." \n &#9851; End - ".$end."",
        ...
        if($tournier_type == 2){
            ...
            foreach ($tourniertable as $t) {
                ...
                $text .= "&#129472; @id".$user->vk_id." (".$user->name.") - ".$prize."r. Scored ".$score." points \n";
                $count_t += 1;
            ...
            $response = $vk->wall()->post($access_token, array(
                'owner_id' => -206394471,
                'message' => "&#128165; Tournament for game mode ".$tournier->game." has ended. \n\n &#9851; Winners: \n ".$text."",
