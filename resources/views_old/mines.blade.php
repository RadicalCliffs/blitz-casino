		...
		<div class="col" style="max-width: 700px;margin: 0px auto;">
			<div class="flex no_padding wrap">
				<div class="col-lg-5">
					...
					<br>
					<label>Колandчестinо бомб</label>
					<div class="flex no_padding wrap" style="margin-top:10px">
					...
					<button class="btn_bet_dice start_block_mine w-100" style="margin-top:20px;display: none" onclick="disable(this);startGameMineNew(this)">andграть <img class="dop_btn" src="img/yellow_coin.svg"> </button>



					<div class="flex no_padding play_block_mine wrap" style="display:none">
						<div class="col-5">
							<button class="btn_bet_dice w-100" style="margin-top:20px" onclick="disable(this);$('.mine').addClass('no_select');finishGameMineNew(this)">forбрать <span id="winMine">0.00</span><img class="dop_btn" src="img/yellow_coin.svg"> </button>
						</div>
						<div class="col-5">
							<button class="btn_bet_dice w-100" style="margin-top:20px" onclick="disable(this);$('.mine').addClass('no_select');autoClickMineNew(this)">Аinтоinыбор </button>
						</div>
					</div>
					...
					<div style="height:40px;margin-bottom: 15px;margin-top: 10px;"><button class="btn-dep w-100" style="margin-top:0px;display: none;" id="checkMine" onclick="checkMine()">Проinерandть andгру</button></div>
					...
					<center>
						<div class="block">
							...
							<div class="win_mine_block" style="display: none">
								<center><div class="winText">inыandгрыш</div><div class="sumWinText"></div></center>
							</div>
						</div>
