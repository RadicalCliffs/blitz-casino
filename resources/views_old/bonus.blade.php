		...
		<div class="col" style="max-width: 700px;margin: 0px auto;position:relative;">
				...
				<div class="col-lg-5 bonus">
					<div class="content-area-bonus" >
						<center>
							...
							<button class="btn_bonus_start" onclick="disable(this);getBonus(this)">Крутandть <svg width="28" height="37" viewBox="0 0 28 37" fill="none" xmlns="http://www.w3.org/2000/svg" class="dop_btn">
			...
			<div class="col-lg-5 bonus">
				<div class="content-area-bonus" style="min-height: 10px;">
					...
					<button class="btn_bonus" onclick="disable(this);getBonusVk(this)">Get</button>
			...
			<div class="content-area-bonus" style="min-height: 10px;">
				...
				<button class="btn_bonus"  onclick="disable(this);getBonusTg(this)">Get</button>
	...
	<div class="content-area-bonus" style="width: 100%;min-height: 50px;">
		...
		<div style="padding: 35px;padding-top: 43px;z-index: 4;position: relative;" class="p_500_10 w-100"> 
			...
			<div style="margin-top: 20px;">
				<span class="text-secondary">Bonusный Balance:</span>
                ...
                $('#all_reposts').append('<div class="col-lg-3 mb-20">\
					<div class="flex no_padding wrap">\
						<div class="col-5" style="max-width:calc(100% - 35px)">\
							<span class="text_bonus" style="margin-top: 0px;font-weight: 700;margin-bottom: 5px">'+e.id+' Level</span>\
