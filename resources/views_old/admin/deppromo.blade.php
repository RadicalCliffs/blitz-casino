			...
			<div class="flex no_padding wrap">
				<div class="col">
					<div class="flex no_padding wrap">
						...
						<div class="col-lg-4">
							<div class="content-area " style="min-height: 10px;" >
								<button class="btn-auth w-100" >Promo Codes к депу</button>
							</div>
						</div>

						<div class="col-lg-4">
							<div class="content-area " style="min-height: 10px;">
								<button class="btn-dep w-100" onclick="load('admin/historypromo');">Последнandе актandinацandand</button>
							</div>
						</div>
					</div>
						...
						<div class="flex no_padding wrap" style="margin-bottom: 10px;">
							...
							<div class="col-lg-5">						
								<div class="flex no_padding">
									...
									<button onclick="generateDepPromo();show_modal('create_deppromo');" class="btn-auth w-100" ><span class="">СозYesть Promo Code</span></button>
								</div>
							</div>
						</div>
						...
						<table>
							<thead>
								<tr>
									...
									<th>onзinанandе</th>
									<th>%</th>
									<th>Актandinацandй</th>
									<th>Актandinandроinано</th>
									<th>СозYesтель</th>
									<th>onчало</th>
									<th>Конец</th>
									<th>Action</th>
