            ...
            <div class="flex no_padding wrap">
                <div class="col">
                    <div class="flex no_padding wrap">
                        ...
                        <div class="col-lg-3">
                            <div class="content-area " style="min-height: 10px;">
                                <button class="btn-auth w-100" onclick="load('admin/settings_status');">Settings прandinandлегandй</button>
                            </div>
                        </div>
                    </div>
                    @php
                    ...
                    <div class="flex no_padding wrap">
                        ...
                        <div class="col-lg-5">
                            <div class="content-area">
                                <span class="text-secondary" id="title_s_w">toбаinленandе прandinandлегandй</span>
                                <div class="flex no_padding wrap" style="margin-top: 20px;">
                                    ...
                                    <div class="col mb-20 buttons_s_w_1">
                                        <button class="btn-auth w-100" onclick="addStatus()">Add</button>
                                    </div>
                                    
                                    <div class="col-lg-5 mb-20 buttons_s_w_2" style="display: none;">
                                        <button class="btn-dep w-100" onclick="closeEditStatus()">Close</button>
                                    </div>
                                    <div class="col-lg-5 mb-20 buttons_s_w_2" style="display: none;">
                                        <button class="btn-auth w-100" onclick="saveEditStatus()">Save</button>
                                    </div>
        ...
        $.post('/status/all',{_token: csrf_token}).then(e=>{
            ...
            e.status.forEach((e)=>{
                ...
                $('#all_status').append('<div class="col-lg-5">\
                    ...
                    <div class="w-100"><span class="text-secondary" style="font-size:16px">Депозandт:</span>    \
                    ...
                    \
                    <div class="flex no_padding wrap">\
                    <div class="col-5"><button class="btn-dep w-100" onclick="deleteStatus('+e.id+')">УYesлandть</button></div>\
                    <div class="col-5"><button class="btn-dep w-100" onclick="editStatus('+e.id+', `'+e.color+'`, `'+e.deposit+'`, `'+e.name+'`, `'+e.bonus+'`)">РеYesктandроinать</button></div>\
                    </div>\
                    </div>\
                    </div>\
                    </div>')
