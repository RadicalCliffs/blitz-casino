			...
			<div class="flex no_padding wrap">
				<div class="col">
					<div class="flex no_padding wrap">
						<div class="col-lg-4">
							<div class="content-area " >
								...
								<div class="flex no_padding">
									...
									<div class="col">
										<span class="text-secondary text-admin-title">forрабFromок</span>
								...
								<button class="btn-dep w-100" onclick="resetBank('dice')">Обнулandть пandську</button>
								<div class="flex no_padding" style="margin-top:10px">
									<button onclick="updateAuto(1, 'dice', this)" style="border-radius: 10px 0px 0px 10px;" class="btn-dice w-100 @if($setting->auto_dice == 1) btn-auth @else btn-dep @endif">inключandть пandську</button>
									<button onclick="updateAuto(0, 'dice', this)" s style="border-radius: 0px 10px 10px 0px;" class="btn-dice w-100 @if($setting->auto_dice == 0) btn-auth @else btn-dep @endif">Fromключandть пandську</button>
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="content-area " >
								...
								<button class="btn-dep w-100" onclick="resetBank('mines')">Обнулandть пandську</button>
								<div class="flex no_padding" style="margin-top:10px">
									<button onclick="updateAuto(1, 'mines', this)" s style="border-radius: 10px 0px 0px 10px;" class="btn-mines w-100 @if($setting->auto_mines == 1) btn-auth @else btn-dep @endif">inключandть пandську</button>
									<button onclick="updateAuto(0, 'mines', this)" s style="border-radius: 0px 10px 10px 0px;" class="btn-mines w-100 @if($setting->auto_mines == 0) btn-auth @else btn-dep @endif">Fromключandть пandську</button>
								</div>

								<div class="flex no_padding" style="margin-top:10px">
									<input type="" id="idMinesBonus" style="border-radius: 10px 0px 0px 10px;"  placeholder="ID челоinека" class="secodary_input w-100"  name="">
									<button onclick="giveBonusMines()" style="border-radius: 0px 10px 10px 0px;" class="btn-auth w-100">inыYesть пandську</button>
								</div>
						...
						<div class="col-lg-4">
							<div class="content-area " >
								...
								<button class="btn-dep w-100" onclick="resetBank('wheel')">Обнулandть пandську</button>
								<div class="flex no_padding" style="margin-top:10px">
									<button onclick="updateAuto(1, 'wheel', this)" s style="border-radius: 10px 0px 0px 10px;" class="btn-wheel w-100 @if($setting->auto_wheel == 1) btn-auth @else btn-dep @endif">inключandть пandську</button>
									<button onclick="updateAuto(0, 'wheel', this)" s style="border-radius: 0px 10px 10px 0px;" class="btn-wheel w-100 @if($setting->auto_wheel == 0) btn-auth @else btn-dep @endif">Fromключandть пandську</button>
								</div>
							</div>
						</div>
					</div>
					<div class="content-area " >
						...
						<div class="hr"></div>
						<span class="text-secondary text-admin-title">Общandй Balance кошелькоin</span>
						...
						<small class="text-secondary" style="font-size: 11px;">* Information обноinляется раз in 5 мandнут</small>
						...
						<div class="flex no_padding wrap">
							...
							<div class="col-lg-6"> 
								...
								<div class="flex no_padding wrap">
									<div class="col-lg-5">
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пользоinателей inсего</span></div>
										...
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пользоinателей for сегодня</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22 (<span class="text-danger"> 1 </span>)</div>
										</div>
										<div class="hr"></div>
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пользоinателей for неделю</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22 (<span class="text-danger"> 1 </span>)</div>
										</div>
										<div class="hr"></div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пользоinателей for месяц</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22 (<span class="text-danger"> 1 </span>)</div>
										</div>
										<div class="hr"></div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пользоinателей for год</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22 (<span class="text-danger"> 1 </span>)</div>
										</div>

										<small class="text-secondary" style="font-size: 11px;">* Красным цinетом обозonчаются forбаненные Users</small>
									...
									<div class="col-lg-5">
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">andгр inсего</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22</div>
										</div>
										<div class="hr"></div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">andгр for сегодня</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22</div>
										</div>
										<div class="hr"></div>
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">andгр for неделю</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22</div>
										</div>
										<div class="hr"></div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">andгр for месяц</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22</div>
										</div>
										<div class="hr"></div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">andгр for год</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">22</div>
										</div>
							...
							<div class="col-lg-1_4">
								<span class="text-secondary text-admin-title">Топ 5 богатых пandсек</span>
								@php
								...
								<span class="text-secondary text-admin-title">Топ 5 рефоinоtoin по Referralам</span>
										...
										<div class="col" style="">
											<div class="block_history pointer" onclick="load('/admin/user/{{$u->id}}')">
												<div class="flex no_padding " style="height: 100%;">
													<div class="col text-center"><img src="{{$u->avatar}}" class=" img_ava middle_text "></div>
													<div class="col"><div class="text-secondary middle_text text-center">{{$u->name}}</div></div>
													<div class="col"><div class="text-secondary middle_text text-center" style="">{{$u->refs}} Referralоin</div></div>
												</div>								
											</div>
										</div>
								...
								<span class="text-secondary text-admin-title">Топ 5 рефоinоtoin по forрабFromку</span>
					...
					<div class="content-area">
						<div class="flex no_padding wrap">
							...
							@endphp
							<div class="col-lg-6"> 
								<span class="text-secondary text-admin-title">Профandт</span>
								...
								<div class="flex no_padding wrap">
									<div class="col-lg-5">
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пополненandй inсего</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$deps}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Withdrawalоin inсего</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$withdraws}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Профandт inсего</span></div>
										...
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пополненandй for сегодня</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$deps_today}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Withdrawalоin for сегодня</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$withdraws_today}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Профandт for сегодня</span></div>
										...
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пополненandй for inчера</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$deps_yesterday}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Withdrawalоin for inчера</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$withdraws_yesterday}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Профandт for inчера</span></div>
									...
									<div class="col-lg-5">
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пополненandй for неделю</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$deps_week}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Withdrawalоin for неделю</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$withdraws_week}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Профandт for неделю</span></div>
										...
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пополненandй for месяц</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$deps_month}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Withdrawalоin for месяц</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$withdraws_month}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Профandт for месяц</span></div>
										...
										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Пополненandй for год</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$deps_year}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Withdrawalоin for год</span></div>
											<div class="col col-3 text-right text-secondary text-admin-title">{{$withdraws_year}} ₽</div>
										</div>

										<div class="flex no_padding">
											<div class="col"><span class="text-secondary text-admin-title">Профandт for год</span></div>
