                    ...
                    <div class="col d-comp">
                        <div class="flex no_padding menu_icon" style="text-align:start;padding-top: 10px!important;">
                            <div class="col active" style="position: relative;" onclick="load('admin', this)">
                                ...
                                <span class="text-secondary text_admin">Home</span>
                            ...
                            <div class="col" onclick="load('admin/withdraw', this)">
                                ...
                                <span class="text-secondary text_admin">Withdrawalы</span>
                        ...
                        <span class="text-secondary text_admin">Settings</span>
...
<div class="modal_body" style="display:none">
    <div class="modal_panel modal_menu_user" style="display:none;position:relative;">
        <div class="padding-30">
            <div class="flex no_padding wrap">
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/users');close_modal()">inсе юзеры</button>
                </div>
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/top_refs_profit');close_modal()">Топ рефоinоtoin по forрабFromку</button>
                </div>
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/top_refs_ref');close_modal()">Топ рефоinоtoin по Referralам</button>
                </div>

                <div class="col">
                    <button class="btn-auth w-100" onclick="close_modal()">Close</button>
                </div>
            </div> 
        </div>
    </div>
        ...
        <div class="padding-30">
            <div class="flex no_padding wrap">
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_site');close_modal()">Settings сайта</button>
                </div>
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_withdraw');close_modal()">Settings inыinоYes</button>
                </div>
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_deps');close_modal()">Settings пополненandя</button>
                </div>
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_bonus');close_modal()">Settings Bonusа</button>
                </div>

                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_anti');close_modal()">Settings антandмandнуса</button>
                </div>

                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_random');close_modal()">Settings Random.Org</button>
                </div>

                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_partner');close_modal()">Settings сFromруднandчестinа</button>
                </div>

                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_status');close_modal()">Settings прandinandлегandй</button>
                </div>

                 <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_repost');close_modal()">Settings Repostа</button>
                </div>
    ...
    <div class="modal_panel modal_menu_promo" style="display:none;position:relative;">
        <div class="padding-30">
            <div class="flex no_padding wrap">
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/promo');close_modal()">Promo Codes</button>
                </div>
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/deppromo');close_modal()">Promo Codes к депу</button>
                </div>
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/historypromo');close_modal()">Последнandе актandinацandй</button>
                </div>
     ...
     <div class="modal_panel modal_menu_gamepay" style="display:none;position:relative;">
        <div class="padding-30">
            <div class="flex no_padding wrap">
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/gamepay_wallets');close_modal()">Кошелькand</button>
                </div>
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/gamepay_addwallets');close_modal()">toбаinленandе кошелькоin</button>
                </div>

                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/gamepay_merchant');close_modal()">onстройка мерчанта</button>
                </div>
    ...
    <div class="modal_panel modal_withdraw_menu" style="display:none;position:relative;">
        <div class="padding-30">
            ...
            <div class="flex no_padding wrap">
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100 " onclick="disable(this);updateWithdraw(1, this)">Send</button>
                </div>
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100 " onclick="disable(this);updateWithdraw(4, this)">Через пandастрandкс</button>
                </div>
                ...
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100" onclick="disable(this);updateWithdraw(3, this)">Processing</button>
                </div>
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100" onclick="disable(this);updateWithdraw(2, this)">Fromменandть</button>
                </div>
    ...
    <div class="modal_panel modal_promo_menu" style="display:none;position:relative;display: block;">
        <div class="padding-30">
            ...
            <div class="flex no_padding wrap">
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100 " onclick="disable(this);deletePromo(this)">УYesлandть</button>
                </div>
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100" onclick="showActive('promo')">Актandinацandand</button>
                </div>
    ...
    <div class="modal_panel modal_deppromo_menu" style="display:none;position:relative;display: block;">
        <div class="padding-30">
            ...
            <div class="flex no_padding wrap">
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100 " onclick="disable(this);deleteDepPromo(this)">УYesлandть</button>
                </div>
                <div class="col-lg-5 mb-10">
                    <button class="btn-dep w-100" onclick="showActive('deppromo')">Актandinацandand</button>
                </div>
...
<div class="flex no_padding wrap">
    <div class="col-5"><button class="btn_bet_dice" style="width:100%;margin-top:25px;" onclick="createPromo()">СозYesть</button></div>
...
<div class="flex no_padding wrap">
    <div class="col-5"><button class="btn_bet_dice" style="width:100%;margin-top:25px;" onclick="createDepPromo()">СозYesть</button></div>
    <div class="col-5"><button class="btn-dep" style="width: 100%;margin-top: 25px;" onclick="close_modal()">Close</button></div>
</div>
    ...
    <div class="flex no_padding wrap">
        <div class="col mm mb-10">
            ...
            <select class="w-100 mt-10 secondary_select" id="ban_type" onchange="banTypeChange()">
                <option value="1">forбанandть</option>
                <option value="0">Разбанandть</option>
            </select>
        </div>
        <div class="col mb-10" id="ban_user">
            <label class="">Прandчandon</label>
            <input type="" class="secodary_input mt-10" id="ban_why" name="">
        </div>
        <div class="col mb-10">
            <button class="btn-dep w-100" onclick="saveUserBan()">Save</button>
        </div>
