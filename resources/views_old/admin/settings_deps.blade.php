 			...
 			<div class="flex no_padding wrap">
 				<div class="col">
 					<div class="flex no_padding wrap">
 						...
 						<div class="col-lg-3">
 							<div class="content-area " style="min-height: 10px;">
 								<button class="btn-auth w-100" onclick="load('admin/settings_deps');">Settings пополненandя</button>
 							</div>
 						</div>
 					...
 					<div class="flex no_padding wrap">
 						...
 						<div class="col-lg-5">
 							<div class="content-area">
 								<span class="text-secondary" id="title_s_w">toбаinленandе сandстем пополненandя</span>
 								<div class="flex no_padding wrap" style="margin-top: 20px;">
                                    ...
                                    <input type="hidden" id="id_ww"  name="">
 									...
 									<div class="col mb-20">
 										<label>Мandнandмальonя Sum пополненandя</label>
 										<div class="flex no_padding wrap">
 											<div style="position:relative;margin-top: 10px;" class="col">
                                    ...
                                    <div class="col-5 mb-20">
                                        <label>Платежonя сandстема</label>
                                        <div class="flex no_padding wrap">
                                            <div style="position:relative;margin-top: 10px;" class="col">
                                    ...
                                    <div class="col-5 mb-20">
                                        <label>Номер сandстемы пополненandя</label>
                                        <div class="flex no_padding wrap">
                                            <div style="position:relative;margin-top: 10px;" class="col">
                                    ...
                                    <div class="col-5 mb-20">
 									...
 									<div class="col-5 mb-20">
                                        ...
                                        <div class="col mb-20 buttons_s_w_1">
                                            <button class="btn-auth w-100" onclick="addSystemDep()">Add</button>
                                        </div>
                                    
                                        <div class="col-lg-5 mb-20 buttons_s_w_2" style="display: none;">
                                            <button class="btn-dep w-100" onclick="closeEditSystemDep()">Close</button>
                                        </div>
                                        <div class="col-lg-5 mb-20 buttons_s_w_2" style="display: none;">
                                            <button class="btn-auth w-100" onclick="saveEditSystemDep()">Save</button>
                                        </div>
...
\
 										<div class="flex no_padding wrap" style="margin-top:10px;">\
 											<div class="col-5"><button class="btn-dep w-100" onclick="deleteSystemDep('+e.id+')">УYesлandть</button></div>\
 											<div class="col-5"><button class="btn-dep w-100" onclick="editSystemDep('+e.id+', `'+e.name+'`, `'+e.img+'`, `'+e.comm_percent+'`,  '+e.min_sum+', '+e.ps+', '+e.number_ps+')">РеYesктandроinать</button></div>\
 										</div>\
 									</div>\
 								</div>')
 			});
