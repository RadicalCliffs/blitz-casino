 					...
 					<div class="flex no_padding wrap">
 						<div class="col-lg-4">
 							<div class="content-area " style="min-height: 10px;">
 								<button class="btn-dep w-100" onclick="load('admin/gamepay_wallets');">Кошелькand</button>
 							</div>
 						</div>

 						<div class="col-lg-4">
 							<div class="content-area " style="min-height: 10px;" >
 								<button class="btn-auth w-100" >toбаinленandе кошелькоin</button>
 							</div>
 						</div>

 						<div class="col-lg-4">
 							<div class="content-area " style="min-height: 10px;">
 								<button class="btn-dep w-100" onclick="load('admin/gamepay_merchant');">onстройка мерчанта</button>
 							</div>
 						</div>
 					</div>
 					<div class="flex no_padding wrap">
 						<div class="col-lg-4">
 							<div class="content-area">
                                <span class="text-secondary">toбаinленandе Qiwi</span>
 								<div class="flex no_padding wrap" style="margin-top: 20px;">
                                    ...
                                    <div class="col mb-20">
                                        <button class="btn-auth w-100" onclick="addWallet('qiwi')">Add</button>
                                    </div>
                                </div>
 						...
 						<div class="col-lg-4">
 							<div class="content-area">
                                <span class="text-secondary">toбаinленandе YooMoney</span>
                                <div class="flex no_padding wrap" style="margin-top: 20px;">
                                    <div class="col mb-20">
                                        <label>Номер кошелька</label>
                                        <div class="flex no_padding wrap">
                                    ...
                                    <div class="col mb-20">
                                        <button class="btn-auth w-100" onclick="addWallet('yoomoney')">Add</button>
                                    </div>
                                </div>
 						...
 						<div class="col-lg-4">
 							<div class="content-area">
                                <span class="text-secondary">toбаinленandе Payeer</span>
                                <div class="flex no_padding wrap" style="margin-top: 20px;">
                                    <div class="col mb-20">
                                        <label>Номер кошелька</label>
                                        <div class="flex no_padding wrap">
                                    ...
                                    <div class="col mb-20">
                                        <button class="btn-auth w-100" onclick="addWallet('payeer')">Add</button>
                                    </div>
                                </div>
