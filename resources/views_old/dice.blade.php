		...
		<div class="col" style="max-width: 700px;margin: 0px auto;position:relative;">
			<div style="">
				...
				<div class="flex no_padding wrap" style="margin-top:25px">
					...
					<div class="col-lg-3 col-input-dice d-comp">
						<div style="">
							<label>inозможый inыandгрыш</label>
							<div style="position:relative;margin-top: 10px;">
				...
				<div class="flex no_padding wrap" style="margin-top:25px">
					...
					<div class="col-lg-5 col-range">
						...
						<button class="btn_bet_dice d-comp" onclick="disable(this);playDice(this)">Крутandть <img class="dop_btn" src="img/yellow_coin.svg"></button>

						<div style="height:40px"><button class="btn-dep w-100" style="margin-top:15px;display: none;" id="checkDice" onclick="checkDice()">Проinерandть andгру</button></div>
