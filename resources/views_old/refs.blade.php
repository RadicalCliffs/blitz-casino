						...
						<center>
							...
							<div class="flex wrap no_padding" style="width: calc(100% - 15px);max-width: 290px;">
								<div class="col-5 bonus">
									@if(\Auth::user()->bonus_refs >= 10)<button class="btn_bonus_start" onclick="disable(this);getBonusRef(this)" style="width:100%">Крутandть</button>@else<button  class="btn_bonus_wait" style="width:100%">Неtoступно</button>
									@endif
								</div>
								<div class="col-5 bonus" style="margin-top: 43px;text-align: right;">
									...
									<span class="ref_colvo"><span id="refs">{{\Auth::user()->bonus_refs}}</span> andз 10</span>
								</div>
							</div>
				...
				<div class="col-lg-5 bonus">
					<div class="content-area-bonus" style="min-height: 10px;padding: 0px;">
						<div style="padding:25px">
							<div class="text_promo_a" style="margin-top:20px">inаша Referralьonя ссылка</div>
							...
							<span class="text-secondary" style="font-size: 12px;">* Получайте 10% From кажtoго пополненandя Referralа</span>
							...
							<div class="flex no_padding wrap" style="margin-top:calc(35px);margin-bottom:0px">
								<div class="col-lg-5">
									<div class="block_info_ref">
										...
										<div>
											<span class="text_info_ref">Referralа</span>
										</div>
									</div>
								</div>
								<div class="col-lg-5">
									<div class="block_info_ref" style="margin-bottom: 10px;">
										...
										<div>
											<span class="text_info_ref">forрабFromано</span>
										</div>
									</div>
								</div>
							</div>
							...
							<div style="">
								<div class="block_info_ref" style="margin-bottom: 10px;">
									...
									<div>
										<span class="text_info_ref">toступно к снятandю</span>
									</div>
								</div>
					...
					<div class="content-area-bonus" style="height: 229px;width: 100%;background: url(img/fon_b.png);position: relative;border-radius: 20px;background-size: cover;background-repeat: no-repeat;">
						...
						<div style="padding: 35px;padding-top: 43px;width: 100%;z-index: 4;position: relative;" class="p_500_10"> 
							...
							<div class="about_promo">Актandinandруй, созYesinай and Yesрand раtoсть Playerам</div>
							<button class="btn_bonus" style="width:152px;margin-top:45px" onclick="show_modal('promo')">Попробоinать</button>
						</div>
