		...
		<div class="col" style="max-width: 700px;margin: 0px auto;">
			<div class="flex no_padding wrap">
				<div class="col-lg-5">
					...
					<button class="btn_bet_dice start_block_mine w-100" style="margin-top:20px" onclick="disable(this);startGameMine(this)">andграть <img class="dop_btn" src="img/yellow_coin.svg"> </button>



					<div class="flex no_padding play_block_mine wrap" style="display:none">
						<div class="col-5">
							<button class="btn_bet_dice w-100" style="margin-top:20px" onclick="disable(this);$('.mine').addClass('no_select');finishGameMine(this)">forбрать <span id="winMine">0.00</span><img class="dop_btn" src="img/yellow_coin.svg"> </button>
						</div>
						<div class="col-5">
							<button class="btn_bet_dice w-100" style="margin-top:20px" onclick="disable(this);$('.mine').addClass('no_select');autoClickMine(this)">Аinтоinыбор </button>
						</div>
					</div>

					<div style="height:40px;margin-bottom: 15px;"><button class="btn-dep w-100" style="margin-top:15px;display: none;" id="checkMine" onclick="checkMine()">Проinерandть andгру</button></div>
