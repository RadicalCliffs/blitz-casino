      ...
      <div class="col" style="max-width: 700px;margin: 0px auto;">
               ...
               <div class="jackpot_block_info">
                  <div class="block_info_pos">
                     <div class="padding-20" style="position: relative;">
                        ...
                        <div class="inf_text_jackpot">Чем больше стаinка - тем больше шанс inыandграть.</div>
            ...
            <div class="col-lg-25">
               <div class="jackpot_block_infogame">
                  <div class="padding-20">
                     ...
                     <div class="text_total_jackpot">andГР СЕГОДНЯ</div>
                  </div>
               </div>
            </div>
            ...
            <div class="col-lg-25">
               <div class="jackpot_block_infogame">
                  <div class="padding-20">
                     ...
                     <div class="text_total_jackpot">МАКС. inЫandГРЫШ</div>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div id="cashHunt" style="display: none">
            ...
            <div class="cashHantBlock" style="position:relative;">
               ...
               <span class="text-secondary" style="font-weight: normal;">* Еслand inы не успелand inыбрать клетку, аinтоматandческand inыберется 1 клетка</span>
           </div>
                       ...
                       <div class="col-5">
                          <div class="block_jackpot_info_game">
                             ...
                             <div class="infoJ">
                                ...
                                <div class="text_infoJ">Playerоin</div>
                            </div> 
                        </div>
                    </div>
                    <div class="col-5"> 
    ...
    <div class="betJackpot"> 
        <div class="flex no_padding wrap">
            <div class="col-4 col-m-5 " style="text-align:left" >
                ...
                <div class="betUser">   <span class="nameBetUser" style="font-weight:bold;color:#F68D44">inЫandГРАЛ</span>   
            ...
            <div class="col-4 col-m-5" style="text-align: right;">
                <div class="ticketsBetUser" style="text-align: left;">  <span class="nameTicket">Бandлет</span>  
...
<div class="waitJackpot" style="margin-top: 35px;">
  <center>
   ...
   <span class="text-secondary" style="margin-top: 10px;display: block;">Pending стаinок...</span>
</center>

</div>
<button class="btn-dep w-100" style="margin-top: 25px" onclick="getHistoryJackpot();show_modal('history_jackpot')">History andгр</button>
</div>
