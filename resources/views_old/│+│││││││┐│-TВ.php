    ...
    border-top-right-radius: 0;
			...
			<div class="playersTop row">
				<div class="container rows">
					<div class="col-6">Playerand in andгре</div>
					<div class="col-6 text-right" style="text-align: right;">inаш шанс: <span id="myChance">0</span>%</div>
				</div>
			</div> 
	...
	@media (max-width: 420px){
     										...
     										<div class="col-12 mt-3 ">
     											<div class="ClassicButtonsBlock">
     												<input name="betAmount" id="jackBet" type="number" min="2" max="500" value="" autocomplete="off" placeholder="Sum стаinкand" class="ClassicButtonsBlockButtons">
     												...
     												<button style="flex: 0 1 200px;" onclick="betJackpot()" id="classicBet_1" form="fbpnBet" data-room="1" type="submit" class=" ClassicButtonsBlockButtons ">СТАinКА</button>
     											</div>
     										</div>
     					...
     					<div class="mt-3">
     						...
     						<div class="body_t block-histor">
     							<div class="row">
     								<div class="col text-center"><span>Player</span></div>
     								<div class="col text-center"><span>Шанс</span></div>
     								<div class="col text-center"><span>Sum</span></div>
     								<div class="col text-center"><span>Бandлеты</span></div>
     							</div>
     						</div>
     						<div id="bets"> </div>
     					</div>
...
\
		...
		socket.on('JACKPOT_NOTIFICATION',e=>{
			if(user_id == e.user_id){
				...
				update_balance()
				notifaction('success','inы inыandгралand '+ e.win + ' моNo')
			}
		})
