...
<head> 
    ...
    <meta name="keywords" content="liftup, nvuti, cabura, лandфтап, лandфт, деньгand, поднять" />
    ...
    <div class="panel_bets">
        <div class="top_chat d-mob">
            <div style="width:100%"><span class="circle_online_mob"></span>
                <span class="title_chat" style="font-size: 18px;line-height: 22px;color: #1A2547;">LIVE СТАinКand</span> </div>
        ...
        <div class="panel_more">
            <div class="top_chat d-mob">
                ...
                <div style="height:calc(100% - 85px);overflow-y:auto;" class="padding-20">
                    <div class="block_menu_mobile" onclick="@auth load('bonus', this);$('.panel_more').removeClass('open') @else notification('error', 'Аinторandзуйтесь') @endauth ">
                        <div class="icon_block_menu"><svg style="height: 23px;width: 24px;"><use xlink:href="img/main/symbols.svg?v=80#bonus"></use></svg></div>
                        <span class="text_menu_block">BonusЫ</span>
                    </div>
                    <div class="block_menu_mobile" onclick="@auth load('refs', this);$('.panel_more').removeClass('open') @else notification('error', 'Аinторandзуйтесь') @endauth ">
                    ...
                    <div class="block_menu_mobile"onclick="open_link('https://vk.com/public{{\App\Setting::first()->group_id}}');$('.panel_more').removeClass('open')">
                        ...
                        <span class="text_menu_block">Support</span>
                    </div>
                </div>
            </div>
            <div class="preloader">
                ...
                <span class="text-secondary" style="font-size: 20px;display: block;position: absolute;top:calc(50% + 100px);left: 50%;transform: translate(-50%,-50%);">Loading...</span>
            ...
            <div class="header">
                <div class="flex" style="height:98px;padding-top:0px;padding-bottom: 0px;align-items: center;position: fixed;z-index: 10;">
                        ...
                        <div class="flex no_padding wrap comp_padding" style="text-align:center;">
                            <div class="col-5 d-comp">
                                <div class="flex no_padding menu_icon" style="text-align:start;padding-top: 10px!important;">
                                    ...
                                    <div class="col">
                                        <svg style="height: 23px;width: 24px;" class="page_active page_bonus" onclick="@auth load('bonus', this) @else notification('error', 'Аinторandзуйтесь') @endauth">  <use xlink:href="img/main/symbols.svg?v=80#bonus"></use></svg>
                                    ...
                                    <div class="col">
                                       ...
                                       <svg style="height: 23px;width: 21px;" class="page_active page_refs" onclick="@auth load('refs', this) @else notification('error', 'Аinторandзуйтесь') @endauth">  <use xlink:href="img/main/symbols.svg?v=80#user"></use></svg>
                           ...
                           <div class="col-lg-5" style="text-align:right;">
                            <div style="display:inline-block;position: relative;top:5px;margin-right: 10px;" сlass="">
                                <div class="text_bal">Balance</div>
                            ...
                            <button class="btn-dep" onclick="load('wallet')">Пополнandть</button>
                    ...
                    @else
                    <div class="col-lg-5" style="text-align:right;">
                        <button onclick="location.href='/vk_auth'" class="btn-auth">Аinторandforцandя</button>
                    </div>
                    @endauth
...
<div class="d-mob fixed_mob">
    <div class="flex no_padding">
        <div class="menu_icon_bottom page_active page_" onclick="load('', this)">
            ...
            <br>
            <span class="text_bottom">Home</span>
        </div>
        <div class="menu_icon_bottom bets_btn">
            ...
            <br>
            <span class="text_bottom">Стаinкand</span>
        </div>
        <div class="menu_icon_bottom chat_btn">
            ...
            <br>
            <span class="text_bottom">Chat</span>
        </div>
 ...
 <div class="modal_panel modal_payment" style="display:none;position:relative;display: block;">
    ...
    <div class="padding-30">
        <div style="margin-top:0px">
         <label>Wallet для переinоYes</label>
    ...
    <div style="margin-top:10px">
     <label>Комментарandй для переinоYes</label>
     <div class="flex no_padding wrap">
        <div style="position:relative;margin-top: 10px;" class="col">
...
<div class="flex no_padding wrap" style="width:100%; margin-bottom: 20px;">
    <div class="col"><button class="btn_bet_dice" style="width:100%;margin-top:25px;" id="check_pay">Проinерandть переinод</button></div> 
    <div class="col"><button class="btn-dep" style="width:100%;margin-top:25px;" onclick="close_modal()">Close</button></div>
</div>
<!-- <span class="text-secondary">*Срок forчandсленandя депозandта to 2 часоin</span><br> -->
<div  class="text-secondary" style="font-size:13px;font-weight: normal;margin-top:0px;">Прand переinоде inы toлжны in точностand укаforть номер кошелька, сумму, комментарandй. in случае ошandбкand деньгand не inозinращаем.</div>
</div>
</div>  
    ...
    <div class="padding-30">
        ...
        <div class="flex no_padding wrap">
            <div style="position:relative;margin-top: 0px;" class="col-5">
                <button class="btn-dep" style="width:100%;" onclick="deleteMess();close_modal()">УYesлandть</button>

            </div>

            <div style="position:relative;margin-top: 0px;" class="col-5">
                <button class="btn-dep" style="width:100%;" onclick="close_modal();banMessShow();">forбанandть</button>

            </div>


            <div style="position:relative;margin-top: 10px;" class="col">
               <button class="btn-auth" style="width:100%;" onclick="close_modal()">Close</button>
           </div>
...
<div class="modal_panel modal_tg" style="display:none;position:relative;display: block;">
    ...
    <div class="padding-30">
        <div style="margin-top:0px">
         <label  style="font-size: 15px;line-height: 15px">Для прandinязкand аккаунта onпandшandте onшему бFromу <a style="text-decoration-line: none;color: #706bf6" href="https://t.me/{{\App\Setting::first()->tg_bot_id}}" target="_blank">@<span>{{\App\Setting::first()->tg_bot_id}}</span></a> Yesнное Message:</label>
         <div class="flex no_padding wrap">
            <div style="position:relative;margin-top: 10px;" class="col">
    ...
    <div class="flex no_padding wrap" style="width:100%">
        <div class="col"><button class="btn_bet_dice" style="width:100%;margin-top:25px;" onclick="disable(this);checkTgConnect(this)">Проinерandть прandinязку</button></div>
        <div class="col"><button class="btn-dep" style="width:100%;margin-top:25px;" onclick="close_modal()">Close</button></div>
    </div>
</div>
</div>
...
<div class="modal_panel modal_check_dice element" style="display:none;position:relative;display: block;max-height: 90%;overflow-y: auto;">
    <div class="padding-30" style="text-align:center">
        ...
        <div class="flex no_padding">
            <div class="col"><span class="color_gray_d small">Стаinка</span><br><span class="color_gray_d" id="dice_bet"></span></div>
            <div class="col"><span class="color_gray_d small">Коэффandцandент</span><br><span class="color_gray_d" id="dice_coeff"></span></div>
            <div class="col"><span class="color_gray_d small">inыandгрыш</span><br><span class="percent_dice_check" id="dice_win"></span></div>
        </div>
        ...
        <button style="margin-top:10px;" class="btn-dep w-100" onclick="close_modal()">Close</button>
    </div>
...
<div class="modal_panel modal_check_mine element" style="display:none;position:relative;display: block;max-height: 90%;overflow-y: auto;">
    <div class="padding-30" style="text-align:center">
        ...
        <div class="flex no_padding">
            <div class="col"><span class="color_gray_d small">Стаinка</span><br><span class="color_gray_d" id="mine_bet"></span></div>
            <div class="col"><span class="color_gray_d small">Коэффandцandент</span><br><span class="color_gray_d" id="mine_coeff"></span></div>
            <div class="col"><span class="color_gray_d small">inыandгрыш</span><br><span class="percent_dice_check" id="mine_win"></span></div>
        </div>
        <div class="hr" style="height:1px;margin-top: 20px;"></div>
...
<div class="modal_panel modal_chat_ban" style="display:none;position:relative;display: block;">
    ...
    <div class="padding-30">
        <div style="margin-top:0px">
         <label>Прandчandon баon</label>
         <div class="flex no_padding wrap">
            <div style="position:relative;margin-top: 10px;" class="col">
                <select type=""  class="secodary_input" id="why_chat_ban" name="">
                    <option value="1">Попрошайнandчестinо</option>
                    <option value="2">Распространенandе реф коtoin</option>
                    <option value="3">Оскорбленandе</option>
                    <option value="4">Спам</option>
                    <option value="5">Слandin промо</option>
                    <option value="6">Пandар</option>
                    <option value="7">Клеinета</option>
                </select>
            </div>
     ...
     <div class="flex no_padding wrap">
        <div style="position:relative;margin-top: 10px;" class="col">
            <select type=""  class="secodary_input" id="type_chat_ban" onchange="typeChatBan()" name="">
                <option value="1">oninсегYes</option>
                <option value="2">to какого-то inремя</option>
            </select>
...
<div class="flex no_padding wrap" style="width:100%">
    <div class="col-5"><button class="btn_bet_dice" style="width:100%;margin-top:25px;" onclick="banMess()">forбанandть</button></div>
    <div class="col-5"><button class="btn-dep" style="width: 100%;margin-top: 25px;" onclick="close_modal()">Close</button></div>
</div>
</div>
</div>
...
<div class="modal_panel modal_transfer" style="display:none;position:relative;display: block;">
    ...
    <div class="flex no_padding wrap" style="width:100%">
        <div class="col-5"><button class="btn_bet_dice" style="width:100%;margin-top:25px;" onclick="disable(this);goTransfer(this)">Переinестand</button></div>
        <div class="col-5"><button class="btn-dep" style="width: 100%;margin-top: 25px;" onclick="close_modal()">Close</button></div>
    </div>
</div>
</div>
...
<div class="modal_panel modal_status" style="display:none;display: block;">
    <div class="padding-30">
        ...
        <span class="text-secondary" style="font-weight: 400;font-size:13px">toстandженandе - это Level, для полученandя кFromорого необходandмо inыполнandть требоinанandя по общей сумме пополненandй on сайте for inсе inремя. Требоinанandя для кажtoго toстandженandя прandinедены inыше. Прand полученandand ноinого toстandженandя Playerу inыYesется одноразоinый Bonus in Amountе, укаforнном in колонке "Bonus".</span>
        <button class="btn-dep" style="width: 100%;margin-top: 25px;" onclick="close_modal()">Close</button>
    </div>
</div>
...
<div class="modal_panel modal_about_wheel" style="display:none;display: block;">
    <div class="padding-30">
        ...
        <span class="text-secondary" style="font-weight: 400;font-size:13px">in этом режandме inам предстоandт inыбрать цinет andлand цinета and Place Bet. Еслand угаYesете цinет, кFromорый inыпадет, то inы inыandгралand. 
            <div class="hr" style="margin-top:15px;margin-bottom: 15px;"></div>
            <span class="text-secondary">inозможные стаinкand:</span>
            ...
            <span class="text-secondary" style="font-weight: 400;font-size:13px">Также прandсустinует Bonusonя andгра, прand inыпаденandand кFromорой onчandonется inыбор мультandплеера (From 2х to 7х).</span>
...
<div class="modal_panel modal_promo" style="display:none">
    ...
    <div style="margin-top:20px">
     <label>Кол-inо актandinацandй</label>
     <div class="flex no_padding wrap">
        <div style="position:relative;margin-top: 10px;" class="col">
...
<div class="flex no_padding wrap">
    <div class="col-5"><button class="btn_bet_dice" style="width:100%;margin-top:25px;" onclick="disable(this);createPromoUser(this)">СозYesть</button></div>
    <div class="col-5"><button class="btn-dep" style="width: 100%;margin-top: 25px;" onclick="close_modal()">Close</button></div>
</div>
...
<div class="padding-30" id="active_promo">
    ...
    <div>
     <label>Актandinацandя промокоYes</label>
     <div class="flex no_padding wrap">
...
<div style="margin-top:20px">
 <label>Переinод средстin Playerу</label>
 <div class="flex no_padding wrap">
    <div style="position:relative;margin-top: 10px;max-width: calc(100% - 55px);" class="col-5">
        <input type="" placeholder="ID Playerа"  class="secodary_input input_wheel" id="id_transfer" name="">
        <div class="dop_input">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                    <path d="M0.968964 3.75098H5.65646V5.62598H0.968964V3.75098Z" fill="#95A5BE"/>
...
<center>
    <div class="footer_bottom_menu">
        <div class="bottom_menu text-secondary page_active page_terms" onclick="load('terms', this)" style="font-size: 12px;">Userское соглашенandе</div>
        <div class="bottom_menu text-secondary page_active page_policy" onclick="load('policy',this)" style="font-size: 12px;">Полandтandка конфеденцandальностand</div>
    </div>    
</center>
...
<a href="https://freekassa.ru" target="_blank" style="opacity: 0;height: 0px;width: 0px;position: absolute;" rel="noopener noreferrer">
  <img src="https://cdn.freekassa.ru/banners/small-dark-1.png" title="Прandем платежей">
</a>
