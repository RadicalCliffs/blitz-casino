        ...
        <div class="chat">
            <div class="panel_chat">
                <div class="top_chat d-comp">
                    <span class="title_chat">Chat</span> 
                ...
                <div class="top_chat d-mob">
                    <div style="width:100%"><span class="circle_online_mob"></span>
                        <span class="title_chat" style="font-size: 18px;line-height: 22px;color: #1A2547;">Chat</span> </div>
                   ...
                   @auth
                    <div class="bottom_chat" style="position:relative;">
                        <input type="" onkeydown="if(event.keyCode==13){ disable(this);sendMess(this); }" class="input_chat" placeholder="Message..." autocomplete="off" name="" id="messageChat">
                        <div class="chat_send" > 
         ...
         <!--    <div class="bottom_chat">
                <input type="" onkeydown="if(event.keyCode==13){ disable(this);sendMess(this); }" class="input_chat" placeholder="Message..." name="" id="messageChat">
