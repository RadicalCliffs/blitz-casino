					...
					<table class="table "  style="margin-bottom: 20px;"> 
						...
						<tbody>
							...
							<tr>
								...
								@if($data['dop'] == 0)
							<th scope="col"><button onclick="changeWithdraw({{$w->id}}, 1)" class="btn btn-info btn-sm me-2">Withdraw</button><button onclick="changeWithdraw({{$w->id}}, 2)" class="btn btn-danger btn-sm">Decline</button></th>
								@endif
							</tr>
							@endforeach
