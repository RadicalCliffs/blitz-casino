...
<div class="row">
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>FreeKassa Payment System Settings</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
						<label>FK ID</label>
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Piastrix Payment System Settings</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Primepayments Payment System Settings</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Linepay Payment System Settings</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
						<label>Project ID</label>
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>Paypaylych Payment System Settings</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
						<label>Project ID</label>
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				<h3>AezaPay Payment System Settings</h3>
				<div class="row">
					<div class="col-lg-3 mb-3">
						<label>Project ID</label>
