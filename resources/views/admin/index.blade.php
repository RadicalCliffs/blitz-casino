...
@section('content')
                ...
                <div class="col-md-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    <p class="text-muted fw-medium">Withdrawals</p>
            ...
            <div class="card">
                    ...
                    <div class="d-sm-flex flex-wrap">
                        ...
                        <div class="ms-auto">
                            <ul class="nav nav-pills stat-pills">
                                <li class="nav-item">
                                    <a class="nav-link active first" onclick="statUpdate(1, this)">Per day</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="statUpdate(2, this)">Per week</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="statUpdate(3, this)">Per month</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="statUpdate(4, this)">Per year</a>
                                </li>
                            </ul>
                        </div>
                    </div>
             ...
             <div class="card">
                <div class="card-body chartAdmin2">
                    <div class="d-sm-flex flex-wrap">
                        <h4 class="card-title mb-4">Profit Statistics</h4>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Recent deposits</h4>
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            <thead class="table-light">
                                <tr>                                    
                                    <th class="align-middle">ID</th>
                                    <th class="align-middle">Sum</th>
