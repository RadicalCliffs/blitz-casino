      ...
      <div class="col" style="max-width: 700px;margin: 0px auto;">
               ...
               <div class="jackpot_block_info">
                  <div class="block_info_pos">
                     <div class="padding-20" style="position: relative;">
                        ...
                        <div class="inf_text_jackpot">The bigger your bet - the higher your chance to win.</div>
            ...
            <div class="col-lg-25">
               <div class="jackpot_block_infogame">
                  <div class="padding-20">
                     ...
                     <div class="text_total_jackpot">GAMES TODAY</div>
                  </div>
               </div>
            </div>
            ...
            <div class="col-lg-25">
               <div class="jackpot_block_infogame">
                  <div class="padding-20">
                     ...
                     <div class="text_total_jackpot">MAX WIN</div>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div id="cashHunt" style="display: none">
            ...
            <div class="cashHantBlock" style="position:relative;">
               ...
               <span class="text-secondary" style="font-weight: normal;">* If you don't select a cell in time, 1 cell will be automatically selected</span>
           </div>
                       ...
                       <div class="col-5">
                          <div class="block_jackpot_info_game">
                             ...
                             <div class="infoJ">
                                ...
                                <div class="text_infoJ">Players</div>
                            </div> 
                        </div>
                    </div>
                    <div class="col-5"> 
...
<!-- <button class="btn-dep w-100" style="margin-top: 25px">What is this?</button> -->
    ...
    <div class="betJackpot"> 
        <div class="flex no_padding wrap">
            <div class="col-4 col-m-5 " style="text-align:left" >
                <img src="/images/default-avatar.png" class="betJackpotAva img_no_blur">
                <div class="betUser">   <span class="nameBetUser" style="font-weight:bold;color:#F68D44">WON</span>   
            ...
            <div class="col-4 col-m-5" style="text-align: right;">
                <div class="ticketsBetUser" style="text-align: left;">  <span class="nameTicket">Ticket</span>  
...
<div class="waitJackpot" style="margin-top: 35px;">
  <center>
   ...
   <span class="text-secondary" style="margin-top: 10px;display: block;">Waiting for bets...</span>
</center>

</div>
<button class="btn-dep w-100" style="margin-top: 25px" onclick="getHistoryJackpot();show_modal('history_jackpot')">Game history</button>
</div>
