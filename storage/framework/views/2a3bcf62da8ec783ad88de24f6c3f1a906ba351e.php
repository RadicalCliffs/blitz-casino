<div class="wrapper">
    <div class="keno">
        ...
        <div class="keno__content">
            ...
            <div class="keno__mines d-flex justify-center align-center"> <!-- When the game ends and you win, add class keno__mines--win and show the win display below -->
                ...
                <div class="keno__canvas d-flex justify-space-between flex-wrap">
                    <?php for($i=1; $i <= 40; $i++): ?>
                    <div class="keno__canvas-item  d-flex align-center justify-center" onclick="selectKeno(<?php echo e($i); ?>, this)">
                        <div class="keno__canvas-users d-flex align-center"></div>
                        <span class="keno__canvas-number" ><?php echo e($i); ?></span>
                        <div class="kenoBonus" style="display:none;">
                            <div class=" d-flex align-center flex-column justify-center" style="position: relative;top: -4px;"> <!-- When multiplier bonus falls into cell -->
...
<script type="text/javascript">
    ...
    getKeno()
</script><?php /**PATH C:\Users\maxmi\OneDrive\Documents\Downloads\GoldenX-CASINO-SITE-main\GoldenX-CASINO-SITE-main\resources\views/keno.blade.php ENDPATH**/ ?>