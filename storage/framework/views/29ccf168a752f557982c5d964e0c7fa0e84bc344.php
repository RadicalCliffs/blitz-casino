        ...
        <div class="crash__top d-flex align-stretch justify-space-between" style="margin-top: 30px;">
            ...
            <div class="crash__right">
                <div class="bx-input d-flex flex-column">
                    ...
                    <a onclick="crashGo()" class="btn btn--blue is-ripples flare d-flex align-center justify-center"><span>Rig</span></a>
                </div>
    ...
    if(e.type == 2){
        e.publishMassiv.forEach((e)=>{
            ...
            if(crash_userId == USER_ID){ 
                bet_user = 0;  
                notification('success', 'You successfully collected')          
...
socket.on('crashFinish',e=>{
    e.arr_win.forEach((e)=>{
        // if(e.user_id == USER_ID){
        //     notification('success','You won '+e.win_user.toFixed(2)+' coins')
        // }
    })
...
<?php endif; ?><?php /**PATH C:\Users\maxmi\OneDrive\Documents\Downloads\GoldenX-CASINO-SITE-main\GoldenX-CASINO-SITE-main\resources\views/crash.blade.php ENDPATH**/ ?>