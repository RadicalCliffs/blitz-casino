...
<?php if(auth()->guard()->check()): ?>
<script type="text/javascript">
    socket.emit('subscribe', 'roomGame_1_<?php echo e(\Auth::user()->id); ?>');
</script>
<?php endif; ?><?php /**PATH C:\Users\maxmi\OneDrive\Documents\Downloads\GoldenX-CASINO-SITE-main\GoldenX-CASINO-SITE-main\resources\views/x100.blade.php ENDPATH**/ ?>