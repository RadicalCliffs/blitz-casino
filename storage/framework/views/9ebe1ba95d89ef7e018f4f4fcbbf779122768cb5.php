...
<div class="chat">
    ...
    <div class="chat__promocode">
                <div class="chat__promocode-inner" <?php if($setting->theme == 0): ?>style="padding-left: 30px;"<?php endif; ?>>
    ...
    <div class="chat__bottom">
        ...
        <div class="chat__smiles chat__smiles--smiles" ss-container>
            <div class="chat__smiles-scroll">
                <?php for($i = 1; $i <= 59; $i++): ?>
                <div onclick="AddSmile(<?php echo e($i); ?>)" class="chat__smiles-item d-flex align-center justify-center"><img src="images/chat/smiles/<?php echo e($i); ?>.png"></div>
                <?php endfor; ?>
        ...
        <div class="chat__smiles chat__smiles--stickers" ss-container>
            <div class="chat__smiles-scroll">
               <?php for($i = 1; $i <= 21; $i++): ?>
               <div onclick="disable(this);sendSticker(<?php echo e($i); ?>, this)" class="chat__smiles-item d-flex align-center justify-center"><img src="images/chat/stickers/<?php echo e($i); ?>.jpg"></div>
               <?php endfor; ?>

           </div>
       </div>
   </div>
</div> <?php /**PATH C:\Users\maxmi\OneDrive\Documents\Downloads\GoldenX-CASINO-SITE-main\GoldenX-CASINO-SITE-main\resources\views/layouts/chat.blade.php ENDPATH**/ ?>