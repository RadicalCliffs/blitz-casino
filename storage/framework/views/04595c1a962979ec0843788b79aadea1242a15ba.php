<div class="mines d-flex justify-center" style="margin-top:35px">
	<div class="mines__wrapper d-flex justify-space-between align-start flex-wrap">
		<div class="mines__left d-flex flex-column justify-center align-center">
			...
			<div class="bx-input">
				<div class="bx-input__input d-flex justify-space-between align-center">
					<label class="d-flex align-center">Number of bombs:</label>
			...
			<div class="bx-input mines__buttons play_block_mine" style="display:none">
				...
				<a  onclick="disable(this);autoClickMineNew(this)" class="btn d-flex align-center justify-center is-ripples flare"><span>Auto-pick</span></a>
			</div>
			<div class="bx-input">
				<div class="mines__x">
...
<?php endif; ?><?php /**PATH C:\Users\maxmi\OneDrive\Documents\Downloads\GoldenX-CASINO-SITE-main\GoldenX-CASINO-SITE-main\resources\views/mines.blade.php ENDPATH**/ ?>