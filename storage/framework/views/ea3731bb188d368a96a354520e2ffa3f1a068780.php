<div style="margin-top: 35px;" class="dice">
	...
	<?php if(\Auth::user()->admin == 1): ?>
		<!-- <div class="dice__chance">
				<div class="dice__select-chance d-flex align-center justify-space-between">
					<a class="dice__type--active">Manual bets</a>
					<a>Auto bets</a>
					<a>Turbo bets</a>
				</div> 
			</div> -->
	...
	<div class="wrapper">
		<div class="dice__bet">
			...
			<div class="dice__x">
				<div class="bx-input__input d-flex align-center justify-space-between">
					<label class="d-flex align-center">Multiplier:</label>
			...
			<div class="dice__play d-flex justify-center align-center" style="grid-column: 1 / 4;">
				<a  class="btn is-ripples flare btn--blue d-flex align-center" onclick="disable(this);playDice(this)" id="dice__play"><span>Roll</span></a>
...
<div style="text-align:center;width: 100%;margin-top: 15px;font-weight: bold;cursor: pointer;display: none;"  id="checkDice" class=""><a  onclick="return false;" rel="popup" data-popup="popup--fair-dice">Verify game</a></div>
	</div>
</div>
<div class="wrapper">
...
<?php if(auth()->guard()->check()): ?>
<script type="text/javascript">
    socket.emit('subscribe', 'roomGame_3_<?php echo e(\Auth::user()->id); ?>');
</script>
<?php endif; ?><?php /**PATH C:\Users\maxmi\OneDrive\Documents\Downloads\GoldenX-CASINO-SITE-main\GoldenX-CASINO-SITE-main\resources\views/dice.blade.php ENDPATH**/ ?>