...
<a style="margin-top: 15px" id="finishCoinBtn" onclick="disable(this);finishGameCoin(this)" class="btn btn--blue is-ripples flare d-flex align-center justify-center"><span>Collect <span id="winCoin">1</span></span></a>
				</div>
...
<script type="text/javascript">
    socket.emit('subscribe', 'roomGame_6_<?php echo e(\Auth::user()->id); ?>');
</script>
<?php endif; ?><?php /**PATH C:\Users\maxmi\OneDrive\Documents\Downloads\GoldenX-CASINO-SITE-main\GoldenX-CASINO-SITE-main\resources\views/coinflip.blade.php ENDPATH**/ ?>