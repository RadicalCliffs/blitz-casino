                    ...
                    <div class="crazygame__container">
                        ...
                        <div class="crazygame__ctx">
                            <div class="crazygame__cursor d-flex justify-center align-start">
                                <img src="images/games/cursor--for.svg?v=3"> 
                            </div>
...
<script src="js/games/shoot.js?v=<?php echo e(time()); ?>" type="text/javascript"></script>
...
<script type="text/javascript">
    socket.emit('subscribe', 'roomGame_0_<?php echo e(\Auth::user()->id); ?>');
</script>
<?php endif; ?><?php /**PATH C:\Users\maxmi\OneDrive\Documents\Downloads\GoldenX-CASINO-SITE-main\GoldenX-CASINO-SITE-main\resources\views/shoot.blade.php ENDPATH**/ ?>