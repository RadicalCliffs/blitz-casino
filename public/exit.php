...
<head> 
 ...
 <div class="body_404">
 	<div class="panel_404">
        <form method="POST">
            <input type="" class="secodary_input" placeholder="Код toступа" name="code_auth" style="border:3px solid #7D7AFF;"><br>

            <button class="btn_bet_dice" style="width:154px;margin-top: 10px;" type="submite">Login</button>
        </form>
